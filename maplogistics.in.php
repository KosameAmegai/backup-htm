...
<body class="home header-transparent  header-sticky header-v1 hide-topbar-mobile">
  ...
  while($row2 = $result2->fetch_assoc()) {
    ...
    ?><!-- SLIDE  -->
                    <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="images/main-slider/<?php echo $row2['image'];  ?>" alt="" title="Home Page 1" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="0" class="rev-slidebg" data-no-retina>
  ...
  <section class="whychoose-1">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-lg-offset-2 col-md-6 quofrm1  secpaddlf">
                        ...
                        <form action="track.php" name="awb" method="get">
                            <div class="fh-form-1 fh-form">
                                <div class="row fh-form-row">
                                    
                                    
                                        
           <input name="awb" value="" placeholder="Tracking No.*" type="text" required>
                                       
                                    <br><br>
                                    
                                    
                                        
                  <input value="Submit" class="fh-btn" type="submit" name="submit">
        ...
        <div class="welcomesec secpadd">
            <div class="container">
                <div class="fh-section-title clearfix  text-center version-dark paddbtm20">
                    <h2>Welcome to Map <span class="main-color">Logistics</span></h2>
                </div>
                <p class="haeadingpara text-center paddbtm40">Map Logistics is one of the most trustworthy logistics company in India.
                ...
                <div class="welservices row">
                    <div class="col-md-4 col-sm-6">
                        <div class="fh-icon-box icon-type-theme_icon style-1 version-dark hide-button icon-left">
                            ...
                            <h4 class="box-title"><a href="#">About Us</a></h4>
                            <div class="desc">
                                <p>
                     We optimize your packaging, manage your materials sourcing, etc.
</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="fh-icon-box icon-type-theme_icon style-1 version-dark hide-button icon-left">
                            ...
                            <h4 class="box-title"><a href="#">Mission</a></h4>
                            <div class="desc">
                                <p>Ensuring business opportunities by   providing more edges to connect</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="fh-icon-box icon-type-theme_icon style-1 version-dark hide-button icon-left">
                            ...
                            <h4 class="box-title"><a href="#">Vision</a></h4>
                            <div class="desc">
                                <p>Provide more edges around the globe by bridging network</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="homecounts">
            <div class="container">
                <h2 class="count-title">Map <span class="main-color">Logistics</span> is a Global Supplier of Transport and logistics Solutions.</h2>
 ...
 <section class="special_services bluebg secpadd">
            <div class="container">
                <div class="row paddbtm40">
                    <div class="col-sm-12">
                        <div class="fh-section-title clearfix  text-left version-light">
                            <h2>Our Specialized in handling for</h2>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="fh-service-box icon-type-theme_icon style-1">
                            <span class="fh-icon"><i class="flaticon-transport-9"></i></span>
                            <h4 class="service-title"><a href="#" class="link" target="_blank">Bulk Cargo</a></h4>
                            
                        </div>
                        <div class="fh-service-box icon-type-theme_icon style-1">
                            <span class="fh-icon"><i class="flaticon-transport-9"></i></span>
                            <h4 class="service-title"><a href="#" class="link" target="_blank">Project Cargo  </a></h4>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="fh-service-box icon-type-theme_icon style-1">
                            <span class="fh-icon"><i class="flaticon-transport-9"></i></span>
                            <h4 class="service-title"><a href="#" class="link" target="_blank">Exhibition Cargo </a></h4>
                           
                        </div>
                        <div class="fh-service-box icon-type-theme_icon style-1">
                            <span class="fh-icon"><i class="flaticon-transport-9"></i></span>
                            <h4 class="service-title"><a href="#" class="link" target="_blank">Over Dimension Cargo</a></h4>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="fh-service-box icon-type-theme_icon style-1">
                            <span class="fh-icon"><i class="flaticon-transport-9"></i></span>
                            <h4 class="service-title"><a href="#" class="link" target="_blank">Cargo’s with Allied Act</a></h4>
